...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        initComponents();
        JtfTaikhoan.setBackground(new java.awt.Color(0, 0, 0, 1));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/224595.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 540));
        ...
        JtfTaikhoan.setFont(JtfTaikhoan.getFont().deriveFont(JtfTaikhoan.getFont().getSize()+2f));
        JtfTaikhoan.setForeground(new java.awt.Color(255, 255, 255));
        JtfTaikhoan.setBorder(null);
        jPanel2.add(JtfTaikhoan, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 140, 240, 30));
        ...
        jPanel2.add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 240, 30));
        ...
        btdangnhap.setForeground(new java.awt.Color(25, 118, 211));
        ...
        jPanel2.add(btdangnhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 306, 341, 40));
    ...
    private void btdangnhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btdangnhapActionPerformed
        ...
        try {
            stmt = conn.prepareStatement("SELECT TaiKhoan, MatKhau, a.MaNV, HoTen, ChucVu FROM (select * from taikhoan WHERE TaiKhoan = ?) as a inner join nhanvien on a.MaNV = nhanvien.MaNV");
            stmt.setString(1, taikhoan);
            ResultSet rs = stmt.executeQuery();
            if (rs.next()) {
                if (matkhau.equals(rs.getString("matkhau"))) {
                    Notification panel = new Notification(this, Notification.Type.SUCCESS, Notification.Location.BOTTOM_RIGHT, "Đăng Nhập Thành Công");
                    panel.showNotification();
                    taikhoan = rs.getString("taikhoan");
                    manv = rs.getString("manv");
                    tennv = rs.getString("hoten");
                    chucvu = rs.getString("chucvu");
                    JFrame qlsach = new Main();
                    qlsach.show();
                    dispose();
                } else {
                    Notification panel = new Notification(this, Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Tài Khoản hoặc mật khẩu không chính xác");
                    panel.showNotification();
                }
            } else {
                Notification panel = new Notification(this, Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Tài Khoản hoặc mật khẩu không chính xác");
